...
export const changePasswordSchema = z
  .object({
    currentPassword: z.string("رمز عبور فعلی الزامی است").min(8, "رمز عبور فعلی باید بیش از 8 حرف باشد"),
    newPassword: z
    ...
    confirmPassword: z.string("رمز عبور فعلی الزامی است").min(1, "تکرار رمز عبور الزامی است"),
  })
